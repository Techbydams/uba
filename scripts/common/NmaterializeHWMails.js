...
jQuery(document).delegate("body", "click", function() {
    jQuery('.advance_wrapper').attr("style", "display: none;");
});

jQuery(document).delegate(".advance_wrapper", "click", function(e) {
    e.preventDefault();
...
function printDivContent(id) {
    ...
    WindowObject.document.write('<html><head><title>' + Constants.FINACLE_TITLE + ' ' + getMessage("MailPrintHeader") + '</title>');
    WindowObject.document.write('<script type="text/javascript" src="scripts/ckeditor/ckeditor.js"></script>');
    WindowObject.document.write('<script type="text/javascript" src="scripts/ria/ajaxfeatures/jquerymin.js"></script>');
    WindowObject.document.write('<script type="text/javascript" src="scripts/common/NcommonMaterialize.js"></script>');
    WindowObject.document.write('<link rel="stylesheet" type="text/css" href="./' + langId + '/consumer/theme/new_style_HW_UX5.css">');
    WindowObject.document.write('<link rel="stylesheet" type="text/css" href="./' + langId + '/corporate/theme/new_style_HW_UX5.css">');
    WindowObject.document.write('<link rel="stylesheet" type="text/css" href="./' + langId + '/consumer/theme/materialize.css">');
    WindowObject.document.write('<link rel="stylesheet" type="text/css" href="./' + langId + '/corporate/theme/styles.css">');
    WindowObject.document.write('<link rel="stylesheet" type="text/css" href="./' + langId + '/corporate/theme/materialize-common.css">')
    WindowObject.document.write('<link rel="stylesheet" type="text/css" href="./' + langId + '/corporate/theme/layout_master.css">');
    WindowObject.document.write('<link rel="stylesheet" type="text/css" href="./' + langId + '/corporate/theme/application_master.css">');
    WindowObject.document.write('<link rel="stylesheet" type="text/css" href="./' + langId + '/corporate/theme/corporateSpecificStyles.css">');
    WindowObject.document.write('<link rel="stylesheet" type="text/css" href="./' + langId + '/corporate/theme/mediaQueryApplication.css">');
    WindowObject.document.write('<link rel="stylesheet" type="text/css" href="./' + langId + '/corporate/theme/materialize_master.css">');
    ...
    WindowObject.document.write('<link rel="stylesheet" type="text/css" href="./' + langId + '/corporate/theme/styles.css">');
    WindowObject.document.write('<link rel="stylesheet" type="text/css" href="./' + langId + '/corporate/theme/materialize-common.css">');
    WindowObject.document.write('<link rel="stylesheet" type="text/css" href="./' + langId + '/consumer/theme/layout_master.css">');
    WindowObject.document.write('<link rel="stylesheet" type="text/css" href="./' + langId + '/consumer/theme/application_master.css">');
    WindowObject.document.write('<link rel="stylesheet" type="text/css" href="./' + langId + '/consumer/theme/retailSpecificStyles.css">');
    WindowObject.document.write('<link rel="stylesheet" type="text/css" href="./' + langId + '/consumer/theme/mediaQueryApplication.css">');
    WindowObject.document.write('<link rel="stylesheet" type="text/css" href="./' + langId + '/consumer/theme/materialize_master.css">');
    ...
    if (calendarType == Constants.HIJRI_DATE) {
        WindowObject.document.write(getMessage("MailPrintedOn") + '  ' + hijriDate);
    } else {
        WindowObject.document.write(getMessage("MailPrintedOn") + '  ' + day + '-' + month + '-' + year + '  ' + hours + ':' + minutes + ':' + seconds + '  ' + suffix);
    }
    if (isIE && browserVersion >= 4) {
        ...
        WindowObject.document.write('<span class="waves-effect waves-light btn waves-input-wrapper" style="margin-top: 5px;" ><input type="button" class="waves-button-input" onclick=printpage() value="' + getMessage("MailPrintButton") + '"/></span>');
    } else {
        WindowObject.document.write('<span class="waves-effect waves-light btn waves-input-wrapper" style="margin-top: 5px;"><input type="button" class="waves-button-input" onclick="mailsprintfunction();" value="' + getMessage("MailPrintButton") + '"/></span>');
    }
    ...
    WindowObject.document.write('<span class="waves-effect waves-light btn reset-btn waves-input-wrapper" style="margin-' + left + ': 5px;"><input type="button" class="waves-button-input" onclick="javascript:window.close();" value="' + getMessage("MailCloseButton") + '"/></span>')
    //End  Ticket #696629
