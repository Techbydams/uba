...
(function(factory) {
    ...
    var $keyboard = $.keyboard = function(el, options) {
        ...
        base.reveal = function(refresh) {
            ...
            // Changed for TOL 795302 - Removing the unsupported characters from virtual keyboard as per SRS
            var meta2Letters = ['[', ']', '{', '}', '\u2039', '\u203a', '^', '*', '"', ',',
                '\\', '|', '/', '<', '>', '$', '@', '!',
                '?', '&', '~', '#', '=', '+', '.'
            ];
        ...
        base.destroy = function(callback) {
            var index,
                ...
                tmp = [kbcss.input, kbcss.locked, kbcss.placeholder, kbcss.noKeyboard,
                    kbcss.alwaysOpen, o.css.input, kbcss.isCurrent
                ].join(' ');
            clearTimeout(base.timer);
    ...
    // Changed for TOL 795302 - Removing the unsupported characters from virtual keyboard as per SRS
    // Changes done at line no 2289 and 2296
