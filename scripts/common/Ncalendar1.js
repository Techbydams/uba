...
function set_datetime(n_datetime, b_close) {
    ...
    if (b_close) {
        closeCal();
        jQuery(targetObject.target).css({
            'color': '#000000'
        });
...
function fnform26AS() {
    document.FormTwentySixASFG.target = "_blank";
    document.FormTwentySixASFG.action = "https://onlineservices.tin.nsdl.com/TIN/LoginSubmit.do";
}